...
from reference.utils.download_utils import get_local_path
from reference.utils import logger
from reference.utils.common_utils import check_frozen_norm_layer
from reference.utils.ddp_utils import is_master, is_start_rank_node
...
for file in os.listdir(models_dir):
    ...
    if (
        ...
        module = importlib.import_module("reference.cvnets.models.classification." + model_name)
