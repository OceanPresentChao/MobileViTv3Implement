...
def get_normalization_layer(
    ...
    **kwargs
    ...
    if norm_type in ["batch_norm", "batch_norm_2d"]:
        ...
        norm_layer = GroupNorm(num_channels=num_features,
    ...
    norm_layer.in_channels = num_features
    norm_layer.out_channels = num_features
    return norm_layer
...
class AdjustBatchNormMomentum(object):
    ...
    def __init__(self, opts, *args, **kwargs):
        ...
        self.warmup_iterations = getattr(
            opts, "scheduler.warmup_iterations", 10000)
        ...
        anneal_method = getattr(
            opts, "model.normalization.adjust_bn_momentum.anneal_nntype", "cosine"
        )
    ...
    def adjust_momentum(self, model: nn.Layer, iteration: int, epoch: int) -> None:
