...
from ...layers import LinearLayer,ConvLayer,GlobalPool,Identity
from ...modules.mobilenetv2_paddle import InvertedResidual
from ...modules.mobilevit_block_paddle import MobileViTBlockv3 as Block

# 装饰器，注册模型
@register_cls_models("mobilevit_v3")
# ViTv3继承自BaseEncoder，BaseEncoder继承自nn.Module
class MobileViTv3(BaseEncoder):
    ...
    def __init__(self, opts, *args, **kwargs) -> None:
        ...
        self.classifier = nn.Sequential(
            ...
            LinearLayer(in_features=out_channels,
