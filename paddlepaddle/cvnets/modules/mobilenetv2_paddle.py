...
from ..layers.non_linear_layers_paddle import get_activation_fn
    ...
    def __init__(
        ...
        **kwargs
        ...
        if expand_ratio != 1:
            ...
            block.add_sublayer(name="act_fn_1", sublayer=act_fn)
        ...
        block.add_sublayer(name="act_fn_2", sublayer=act_fn)
        ...
        if use_se:
            ...
            block.add_sublayer(name="se", sublayer=se)
